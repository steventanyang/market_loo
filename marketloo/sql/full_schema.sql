create table
  ...
  public.orders (
    ...
    constraint orders_outcome_id_fkey foreign key (outcome_id) references outcomes (outcome_id),
  ...
  public.outcomes (
    ...
    constraint outcomes_market_id_fkey foreign key (market_id) references markets (id)
  ) tablespace pg_default;
